...
<html lang="pt-br">
    <head>
        ...
        })(window,document,'script','dataLayer','GTM-KTH7NM8');</script>
...
header('Location: https://m.plataformanet.com.br');
...
?>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?php print base_url('assets/site/img/favicon.ico');?>">
    ...
    <body id="<? print (isset($bodyImg))?($bodyImg):("");?>">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KTH7NM8"
...
<script type="text/javascript">
  new RDStationForms('contato-fa114629f14d171a75d7-html', 'UA-120680143-1').createForm();
</script>
    </body>
    <?php
